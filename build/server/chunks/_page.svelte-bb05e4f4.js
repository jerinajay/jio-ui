...
<div class="container"><div class=""><div class="md:w-[80%]">${validate_component(Player_1, "Player").$$render($$result, { channel, id }, {}, {})}</div></div>
    <div class="md:w-[80%] mb-4 m-3">${channel.isCatchupAvailable ? `<h3 class="mt-4 sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Catchup</h3>
            ...
            <div class="grid grid-cols-4 text-center gap-3"><a class="text-white text-lg rounded-lg p-1 bg-blue-700" href="${"/catchup/" + escape(id, true) + "/0"}" data-sveltekit-preload-data="hover"><div></div>Today</a>
                ...
                <a class="text-white text-lg rounded-lg p-1 bg-blue-700" href="${"/catchup/" + escape(id, true)}" data-sveltekit-preload-data="hover"><div></div>All</a></div>` : ``}
        ${!channel.isCatchupAvailable ? `<h3 class="mt-4 sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Catchup is not available</h3>` : ``}</div></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-bb05e4f4.js.map
